...
interface SignedDecimalFakeInterface extends ethers.utils.Interface {
  functions: {
    "div(tuple,tuple)": FunctionFragment;
    "divScalar(tuple,int256)": FunctionFragment;
    "mul(tuple,tuple)": FunctionFragment;
    "mulScalar(tuple,int256)": FunctionFragment;
  };
...
export class SignedDecimalFake extends Contract {
  ...
  interface: SignedDecimalFakeInterface;
