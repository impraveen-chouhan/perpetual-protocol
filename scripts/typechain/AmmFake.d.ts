...
interface AmmFakeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getInputPriceWithReservesPublic(uint8,tuple,tuple,tuple)": FunctionFragment;
    ...
    "getOutputPriceWithReservesPublic(uint8,tuple,tuple,tuple)": FunctionFragment;
    ...
    "mockSetReserve(tuple,tuple)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getInputPriceWithReservesPublic",
    values: [
      BigNumberish,
      { d: BigNumberish },
      { d: BigNumberish },
  ...
  encodeFunctionData(
    functionFragment: "getOutputPriceWithReservesPublic",
    values: [
      BigNumberish,
      { d: BigNumberish },
      { d: BigNumberish },
  ...
  encodeFunctionData(
    functionFragment: "mockSetReserve",
...
export class AmmFake extends Contract {
  ...
  functions: {
    ...
    getInputPriceWithReservesPublic(
      _dir: BigNumberish,
      _quoteAssetAmount: { d: BigNumberish },
      _quoteAssetPoolAmount: { d: BigNumberish },
      _baseAssetPoolAmount: { d: BigNumberish },
    ...
    "getInputPriceWithReservesPublic(uint8,tuple,tuple,tuple)"(
      _dir: BigNumberish,
      _quoteAssetAmount: { d: BigNumberish },
      _quoteAssetPoolAmount: { d: BigNumberish },
      _baseAssetPoolAmount: { d: BigNumberish },
    ...
    getOutputPriceWithReservesPublic(
      _dir: BigNumberish,
      _baseAssetAmount: { d: BigNumberish },
      _quoteAssetPoolAmount: { d: BigNumberish },
      _baseAssetPoolAmount: { d: BigNumberish },
    ...
    "getOutputPriceWithReservesPublic(uint8,tuple,tuple,tuple)"(
      _dir: BigNumberish,
      _baseAssetAmount: { d: BigNumberish },
      _quoteAssetPoolAmount: { d: BigNumberish },
      _baseAssetPoolAmount: { d: BigNumberish },
    ...
    "isOverFluctuationLimit(uint8,tuple)"(
      _dirOfBase: BigNumberish,
      _baseAssetAmount: { d: BigNumberish },
      overrides?: CallOverrides
    ): Promise<[boolean]>;
    ...
    mockSetReserve(
      _quoteReserve: { d: BigNumberish },
      _baseReserve: { d: BigNumberish },
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "mockSetReserve(tuple,tuple)"(
      _quoteReserve: { d: BigNumberish },
      _baseReserve: { d: BigNumberish },
      overrides?: Overrides
    ): Promise<ContractTransaction>;
    ...
    "swapInput(uint8,tuple,tuple,bool)"(
      _dirOfQuote: BigNumberish,
      _quoteAssetAmount: { d: BigNumberish },
      _baseAssetAmountLimit: { d: BigNumberish },
      _canOverFluctuationLimit: boolean,
  ...
  filters: {
    ...
    PriceFeedUpdated(priceFeed: null): EventFilter;
