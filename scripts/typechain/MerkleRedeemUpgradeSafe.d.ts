...
interface MerkleRedeemUpgradeSafeInterface extends ethers.utils.Interface {
  functions: {
...
export class MerkleRedeemUpgradeSafe extends Contract {
  ...
  interface: MerkleRedeemUpgradeSafeInterface;
