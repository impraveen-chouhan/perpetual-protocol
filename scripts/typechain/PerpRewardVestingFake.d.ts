...
interface PerpRewardVestingFakeInterface extends ethers.utils.Interface {
  functions: {
...
export class PerpRewardVestingFake extends Contract {
  ...
  interface: PerpRewardVestingFakeInterface;
