...
interface ClearingHouseFakeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "closePositionWithReferral(address,tuple,bytes32)": FunctionFragment;
    ...
    "getPrepaidBadDebt(address)": FunctionFragment;
    ...
    "isInRestrictMode(address,uint256)": FunctionFragment;
    ...
    "mockSetRestrictionMode(address)": FunctionFragment;
    ...
    "openPositionWithReferral(address,uint8,tuple,tuple,tuple,bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getPrepaidBadDebt",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "isInRestrictMode",
  ...
  encodeFunctionData(
    functionFragment: "mockSetRestrictionMode",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class ClearingHouseFake extends Contract {
  ...
  interface: ClearingHouseFakeInterface;
  ...
  functions: {
    ...
    "closePositionWithReferral(address,tuple,bytes32)"(
      _amm: string,
      _quoteAssetAmountLimit: { d: BigNumberish },
      _referralCode: BytesLike,
      overrides?: Overrides
    ...
    "isInRestrictMode(address,uint256)"(
      _amm: string,
      _block: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[boolean]>;
    ...
    mockSetRestrictionMode(
      _amm: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "mockSetRestrictionMode(address)"(
      _amm: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
    ...
    "openPositionWithReferral(address,uint8,tuple,tuple,tuple,bytes32)"(
      _amm: string,
      _side: BigNumberish,
      _quoteAssetAmount: { d: BigNumberish },
      _leverage: { d: BigNumberish },
    ...
    "setPartialLiquidationRatio(tuple)"(
      _ratio: { d: BigNumberish },
      overrides?: Overrides
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    ReferredPositionChanged(referralCode: BytesLike | null): EventFilter;
  ...
  estimateGas: {
    ...
    setTollPool(_feePool: string, overrides?: Overrides): Promise<BigNumber>;
