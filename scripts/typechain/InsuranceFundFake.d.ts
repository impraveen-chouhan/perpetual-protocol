...
interface InsuranceFundFakeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "testGetOrderedQuoteTokens(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testGetOrderedQuoteTokens",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class InsuranceFundFake extends Contract {
  ...
  interface: InsuranceFundFakeInterface;
  ...
  functions: {
    ...
    testGetOrderedQuoteTokens(
      _exceptionQuoteToken: string,
      overrides?: CallOverrides
    ): Promise<[string[]] & { orderedTokens: string[] }>;

    "testGetOrderedQuoteTokens(address)"(
      _exceptionQuoteToken: string,
      overrides?: CallOverrides
    ): Promise<[string[]] & { orderedTokens: string[] }>;
