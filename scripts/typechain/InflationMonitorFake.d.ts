...
interface InflationMonitorFakeInterface extends ethers.utils.Interface {
  functions: {
...
export class InflationMonitorFake extends Contract {
  ...
  interface: InflationMonitorFakeInterface;
